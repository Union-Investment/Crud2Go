 ...
 * 
 */
public class MySQLDatabaseQueryDelegate implements DatabaseQueryDelegate {

	private static final long serialVersionUID = 1L;

	private static final Logger LOG = LoggerFactory
			.getLogger(MySQLDatabaseQueryDelegate.class);
	 ...
	 */
	public MySQLDatabaseQueryDelegate(String queryString,
	...
	public StatementHelper getQueryStatement(int offset, int limit) {
		...
		if (offset >= 0 && limit > 0) {
			query.append(" LIMIT ").append(Integer.toString(offset))
					.append(",").append(Integer.toString(limit));
		}
