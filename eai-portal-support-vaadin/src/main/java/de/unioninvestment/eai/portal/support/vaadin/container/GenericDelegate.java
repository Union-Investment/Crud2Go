...
public interface GenericDelegate {
	 ...
	 * @param context
	 *            Kontext der Update-Operation. Über diesen lässt sich das
	 *            Verhalten des Containers genauer steuern
	 */
	void update(List<GenericItem> items, UpdateContext context);
}
