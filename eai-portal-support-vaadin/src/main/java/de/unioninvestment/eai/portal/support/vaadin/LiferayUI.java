 ...
 */
public abstract class LiferayUI extends UI {

	private static final long serialVersionUID = 1L;

	public static LiferayUI getCurrent() {
		return (LiferayUI) UI.getCurrent();
	}
	...
	public final void init(VaadinRequest request) {
		readContextInformationFromCurrentRequest();
		doInit(request);
	}
	 ...
	 */
	public abstract void doInit(VaadinRequest request);
}
