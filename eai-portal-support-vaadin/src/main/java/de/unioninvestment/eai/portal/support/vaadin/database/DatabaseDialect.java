...
public enum DatabaseDialect {
	MYSQL(new StringDecorator("`", "`")), //
	ORACLE(new StringDecorator("\"", "\""));
	
	private final StringDecorator stringDecorator;
	
	private DatabaseDialect(StringDecorator decorator) {
		this.stringDecorator = decorator;
	}
	
	public StringDecorator getStringDecorator() {
