...
public class RequiredValidatorTest extends AbstractValidatorTest {
	...
	private RequiredValidator validator = new RequiredValidator("Fehler");

	@Test
	public void shouldFailValidatingNullOrEmptyInput() {
		expectFieldValueProducesErrorMessage(validator, null, "Fehler");
