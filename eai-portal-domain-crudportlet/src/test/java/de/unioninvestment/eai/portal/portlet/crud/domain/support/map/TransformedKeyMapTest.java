...
public class TransformedKeyMapTest {
	@Mock
	private ValueTransformer<String, Integer> transformerMock;
	private TransformedKeyMap<String, Integer> map;

	@Before
	public void setUp() {
		MockitoAnnotations.initMocks(this);
		when(transformerMock.transform("ABC")).thenReturn(5);
		map = new TransformedKeyMap<String, Integer>(singleton("ABC"),
				transformerMock);
	}
