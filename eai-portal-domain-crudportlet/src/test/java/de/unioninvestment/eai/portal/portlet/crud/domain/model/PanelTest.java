...
public class PanelTest {
	...
	@Mock
	private PanelConfig configMock;
	...
	@Test
	public void nullConfigInConstructorShouldCauseIllegalArgumentException() {
		try {
			new Panel(null);
	...
	@Test
	public void shouldNotUseHorizontalLayoutWithoutConfiguration() {
		panel = new Panel();
		assertThat(panel.isHorizontalLayout(), is(false));
	}
	...
	public void shoutUseHorizontalLayout() {
		...
		assertThat(panel.isHorizontalLayout(), is(true));
	}
}
