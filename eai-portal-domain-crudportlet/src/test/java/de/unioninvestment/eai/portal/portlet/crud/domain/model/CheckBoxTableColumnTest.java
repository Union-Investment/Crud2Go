...
public class CheckBoxTableColumnTest {
	...
	public void setUp() {
		...
		when(checkboxConfigMock.getCheckedValue()).thenReturn("true");
		when(checkboxConfigMock.getUncheckedValue()).thenReturn("false");
		boxTableColumn = new CheckBoxTableColumn(checkboxConfigMock);
	}
	...
	@Test
	public void shouldGetEmtyPropertieValue() {
		assertThat(boxTableColumn.getCheckboxProperty(), notNullValue());
	}
