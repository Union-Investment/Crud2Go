...
/**
 * 
 * Filterklasse für ein StartsWith-Operator.
 * 
 */
public class StartsWith extends Filter {
	 ...
	 */
	public StartsWith(String column, Object value, boolean caseSensitive, boolean durable) {
		super(durable);
		this.column = column;
		this.value = value;
	...
	public String toString() {
		return "StartsWith [column=" + column + ", value=" + value + "]";
	}
