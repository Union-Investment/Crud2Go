...
public class PortletRole implements Serializable, Role {
	...
	public void registerAsLiferayResource(String owner) {
		portal.registerResource(PortletRole.class.getName(), primKey, owner);
	}
	...
	public boolean isMember(User user) {
		return portal.hasPermission(user.getName(), "MEMBER",
				PortletRole.class.getName(), primKey);
	}
	...
	public String getPermissionsURL() {
		return PermissionsUtil.buildURL(PortletRole.class.getName(), primKey, name);
	}
}
