...
/**
 * Event für im Container aktualisierte Zeilen. Wird z. Zt. nicht über den
 * {@link EventBus} gesendet.
 * 
 * @author carsten.mjartan
 */
public class UpdateEvent implements
		SourceEvent<UpdateEventHandler, DataContainer> {
	 ...
	 */
	public UpdateEvent(DataContainer container, ContainerRow row) {
	...
	@Override
	public void dispatch(UpdateEventHandler eventHandler) {
