...
public abstract class User {
	...
	public boolean hasPermissions(SecurableConfig securableConfig,
		...
		if (securableConfig.getPermissions() != null) {
			...
			for (PermissionConfig perm : securableConfig.getPermissions()
					.getEntries()) {
				if (permissionMatches(permission, perm.getAction())
	...
	private boolean permissionMatches(String permission, String action) {
		return action.equals("all") || action.equals(permission);
	}
