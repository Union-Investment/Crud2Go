...
/**
 * 
 * Schnittstelle für die Behandlung von {@link TabChangeEvent}s.
 * 
...
public interface TabChangeEventHandler extends EventHandler {
	...
	/**
	 * 
	 * Methode die den OnTabChange-Event verarbeitet.
	 * 
	 * @param event
	 *            TabChangeEvent
	 */
	public abstract void onTabChange(TabChangeEvent event);
}
