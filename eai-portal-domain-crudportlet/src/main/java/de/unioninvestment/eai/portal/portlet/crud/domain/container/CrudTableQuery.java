...
/**
 * Kopie des Sourcecodes von {@link TableQuery}, der um die Möglichkeit
 * erweitert wurde eine Timeout Zeit zu setzen.<br/>
 * Der Timeout bezieht sich auf das Count-Query. Wird ein Timeout-Wert größer 0
 * gesetzt und das Count-Query benötigt länger als diese Zeit, wird eine
 ...
 */
public class CrudTableQuery extends AbstractTimeoutableQueryDelegate implements
	...
	/**
	 * @return der Spaltenname der Versionsspalte
	 */
	...
	/**
	 * @param column
	 *            der Spaltenname der Versionsspalte
	 */
	...
	/**
	 * @return der Generator für SQL-Statements
	 */
