...
import de.unioninvestment.eai.portal.portlet.crud.domain.model.AbstractAction;
import de.unioninvestment.eai.portal.support.vaadin.mvp.EventBus;
import de.unioninvestment.eai.portal.support.vaadin.mvp.SourceEvent;

/**
 * Event für das Ausführen von Aktionen, wird z. Zt. nicht über den
...
public class ExecutionEvent implements
	...
	@Override
	public void dispatch(ExecutionEventHandler eventHandler) {
		eventHandler.onExecution(this);
	}
