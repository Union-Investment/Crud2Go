 ...
 * 
 */
@org.springframework.stereotype.Component("dateDataType")
public class DateDataType implements DisplaySupport, EditorSupport,
		SelectSupport {
	...
	public String formatPropertyValue(Property property, Format format) {
		...
		return TimestampUtils.formatTimestamp(new Timestamp(value.getTime()));
	}
	...
	public Field createField(Class<?> type, Object propertyId,
		...
		TextField textField = new FormattedTextField(new DateFormatter());
