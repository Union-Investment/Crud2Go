...
public class FormattingValidator implements Validator {
	...
	public FormattingValidator(AbstractField<?> field) {
		this.field = field;
	}
	...
	public void validate(Object value) throws InvalidValueException {
		try {
			if (value instanceof String && field.getConverter() != null) {
				Converter<Object, Object> converter = (Converter<Object, Object>) field
						.getConverter();
				converter.convertToModel(value, converter.getModelType(), null);
			}
		} catch (Exception e) {
