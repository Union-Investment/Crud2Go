...
public class SQLContainerPatchAspect {
	 ...
	 * @param item
	 *            das {@link RowItem}, auf dem die Filterprüfung stattfinden
	 *            soll
	 * @return eine gecachete oder neu gelesene PortletConfig Instanz
	 * @throws Throwable
	 *             bei Fehler
	 */
	@Around(value = "execution(* com.vaadin.data.util.sqlcontainer.SQLContainer.itemPassesFilters(..)) && args(item)")
