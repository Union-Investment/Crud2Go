...
public class CustomColumnGeneratorImplTest {
	...
	public void shouldRunClosureWithArguments() {
		...
		Mockito.when(closureMock.call(Mockito.any(ScriptRow.class), Mockito.any(VaadinBuilder.class))).thenReturn(componentMock );
		
		// when
		CustomColumnGenerator columnGenerator = new CustomColumnGeneratorImpl(closureMock, applicationMock);
