...
public class DynamicColumnStyleRendererTest {
	...
	private DynamicColumnStyleRenderer columnStyleRenderer;
	...
	public void setUp() throws InstantiationException, IllegalAccessException {
		...
		when(containerMock.getCachedRow(containerRowIdMock, false,
				true)).thenReturn(
				containerRowMock);
		columnStyleRenderer = new DynamicColumnStyleRenderer(tableMock,
				closureMock, "COL1");
	}
	...
	public void shouldGetString() throws Exception {
		...
		String style = columnStyleRenderer.getStyle(containerRowIdMock);
	...
	public void shouldProvideRowAndColumnNameToClosure() throws Exception {
		letClosureReturn("error");
		columnStyleRenderer.getStyle(containerRowIdMock);
