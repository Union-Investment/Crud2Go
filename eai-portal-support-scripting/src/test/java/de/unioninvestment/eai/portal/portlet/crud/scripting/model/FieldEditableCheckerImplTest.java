...
public class FieldEditableCheckerImplTest {
	...
	public void shouldCallClosureWithArguments() {
		...
		Mockito.when(
				closureMock.call(Mockito.any(Table.class),
						Mockito.any(String.class), Mockito.any(ScriptRow.class)))
				.thenReturn(expectedResult);

		// when
		String columnName = "test-column-name";
		FieldEditableCheckerImpl editableChecker = new FieldEditableCheckerImpl(
				tableMock, columnName, closureMock);
