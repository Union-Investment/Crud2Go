...
public class ScriptCompilerTest {
	...
	@Test
	public void shouldCompileScript() throws InstantiationException,
			IllegalAccessException, ScriptingException {
		String source = "'Test'";
		Class<Script> scriptClass = compiler.compileScript(source);
		assertThat((String) scriptClass.newInstance().run(), is("Test"));
	}
	...
	public void shouldRejectInternalScriptEvaluation()
			...
			ScriptingException {
		compiler.compileScript("new GroovyShell()");
	}
}
