 ...
 */
public class ExportColumnSelectionContext implements SelectionContext {
	 ...
	 *            Tabellenspaltenname
	 */
	public ExportColumnSelectionContext(ValuesRow row, String columnName) {
		this.row = row;
