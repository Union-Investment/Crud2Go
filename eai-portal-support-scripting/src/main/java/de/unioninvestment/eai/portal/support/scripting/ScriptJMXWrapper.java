...
public class ScriptJMXWrapper {
	...
	/**
	 * No-args constructor causes the globally available, platform
	 * <code>MBeanServer</code> to be used.
	 * 
	 * @author Jan Malcomess (codecentric AG)
	 * @since 1.46
	 * @see JMXWrapper#JMXWrapper()
	 */
	public ScriptJMXWrapper() {
		this.jmxWrapper = new JMXWrapper();
	}
