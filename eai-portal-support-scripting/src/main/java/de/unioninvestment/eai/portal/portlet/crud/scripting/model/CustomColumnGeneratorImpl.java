...
public class CustomColumnGeneratorImpl implements CustomColumnGenerator {
	...
	private final Closure<Component> closure;
	 ...
	 */
	public CustomColumnGeneratorImpl(Closure<Component> closure,
	...
	public Component generate(ContainerRow row) {
		...
		return closure.call(scriptRow, new VaadinBuilder(application));
	}
