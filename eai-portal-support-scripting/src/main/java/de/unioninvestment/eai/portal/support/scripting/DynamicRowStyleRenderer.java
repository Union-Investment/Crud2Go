...
/**
 * Ist für das setzen der Styleklasse auf einer Zeile zuständig.
 * 
 * 
 * @author siva.selvarajah
 */
public class DynamicRowStyleRenderer implements RowStyleRenderer {
	 ...
	 *            Closure
	 */
	public DynamicRowStyleRenderer(Table table, Closure<?> rowStyleClosure) {
